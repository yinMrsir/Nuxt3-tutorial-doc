...
```shell
mkdir pages/column/\[column\]/video 

# 路由地址：/column/movie/video/:id
touch pages/column/\[column\]/video/\[id\].vue
```
...
```shell
mkdir -p plugins/xgplayer/payTip
# 创建插件css文件
touch plugins/xgplayer/payTip/index.css
# 创建插件文件
touch plugins/xgplayer/payTip/index.ts
```
